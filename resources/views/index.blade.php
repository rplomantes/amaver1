...
<div id="requesttoenroll">
    ...
    <div class="form-group">
        <input type="file" name="tor" class="file">
    </div>
    <h4>For High School Graduate</h4>
    <p>Upload scanned copy of High School Diploma, Form 137 and Birth Certificate</p>
    <div class="form-group">
    <label for="diploma">High School Diploma</label><input type="file" name="diploma">
    </div>
    <div class="form-group">
    <label for="form137">Form 137</label><input type="file" name="form137">
    </div>
    <div class="form-group">
        <label for="birthcertificate">Birth Certificate</label><input type="file" name="birthcertificate">
    </div>
...
<tr>
<td colspan="3">
<input type="hidden" value="{{ $requestid1 }}" name ="requestid">
...
@if(count($myselecteddegree) > 0)
 ...
 @endif
    ...
    <div class="list-group-item active" style="background-color: maroon"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> <b>Courses for payment</b></div>
 ...
 <div style="padding: 10px; background-color: #99CCFF;maargin-bottom:20px ">
   ...
   <div id="requirements">
       <div style="padding: 10px; background-color: #ddd;margin-bottom:20px;">
           ...
           <table class="table table-bordered"><thead><tr><th>Document</th><th>Remarks</th></tr>
           </thead>
           <tbody>
               <tr><td>TOR</td><td>
