...
<html lang="en">
    ...
    <body>
        ...
        <h3 style="text-align:center;">CERTIFICATE OF REGISTRATION</h3>
        <br>
        <table width='100%' border="0" style="border: 0px"> 
            ...
            <tr>
                ...
                <td style="border: 0px"><div style="display: inline-block;width: 100%;"><b>NATIONALITY:</b></div></td>
                <td style="border: 0px"><div style="display: inline-block;width: 100%; text-align: right;">{{$studentInfo->country}}</div></td>
            </tr>
            <tr>
                ...
                <td style="border: 0px"><div style="display: inline-block;width: 100%;"><b style="padding-right: 20px">BIRTHDATE:</b></div></td>
                <td style="border: 0px"></td>
            </tr>
            <tr>
                <td style="border: 0px"><div style="display: inline-block;width: 100%;"><b style="padding-right: 20px;">PAYMENT:</b></td>
                <td style="border: 0px"><div>{{$studentInfo->addr1}}, {{$studentInfo->city}}, {{$studentInfo->state}}, {{$studentInfo->country}}</div></td>
                <td style="border: 0px"></td>
                <td style="border: 0px"></td>
            </tr>
